...
<body>
    ...
    <div class="container">
      <div class="row flex-center">
        <div class="col-md-6 col-lg-4 text-center mb-6 mb-md-0 order-0 order-md-1">
          <img class="shadow-collab" src="assets\img\gallery\WhatsApp Image 2023-12-12 at 2.03.08 AM.jpeg" width="300" alt="About Us Image" style="border-radius:3rem;" />
        </div>
        <div class="col-md-6 text-center text-md-start mb-6 offset-lg-1">
          <h6 class="fs-0 text-uppercase fw-bold text-primary">Who We Are</h6>
          <h6 class="fw-bold fs-3 fs-lg-5 lh-sm">Empowering Businesses</h6>
          <p class="my-4 fs-1 pe-xl-8">By providing essential tools for inventory management, order processing, and customer relationships, we empower shop owners to focus on what they do best.With our system, shop owners can save time and money, while also improving their efficiency and profitability.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-6">
    <div class="container">
      <div class="row flex-center">
        <div class="col-md-6 col-lg-4 text-center mb-6 mb-md-0 order-0 order-md-1">
          <img class="shadow-lg" src="assets\img\gallery\WhatsApp Image 2023-12-12 at 1.53.56 AM.jpeg" width="300" alt="Core Values Image" style="border-radius:3rem;" />
        </div>
        <div class="col-md-6 text-center text-md-start mb-6 offset-0">
          <h6 class="fs-0 text-uppercase fw-bold text-primary">Our Core Values</h6>
          <h6 class="fw-bold fs-3 fs-lg-5 lh-sm">Integrity, Innovation, Collaboration</h6>
          <p class="my-4 fs-1 pe-xl-8">We uphold core values of integrity, innovation, and collaboration. These principles guide our interactions and decision-making processes.</p>
        </div>
      </div>
    </div>
  </section>
